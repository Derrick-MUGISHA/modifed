...
export default function KigaliEvents() {
  ...
  const sponsors = [
    "https://media.globalcitizen.org/thumbnails/b1/30/b1306303-81c8-4d2c-98d0-fc780528aa72/move_afrika_john_legend_resize.png__1600x900_crop_subsampling-2.png",
    "https://media.globalcitizen.org/thumbnails/b1/30/b1306303-81c8-4d2c-98d0-fc780528aa72/move_afrika_john_legend_resize.png__1600x900_crop_subsampling-2.png",
    "https://media.globalcitizen.org/thumbnails/b1/30/b1306303-81c8-4d2c-98d0-fc780528aa72/move_afrika_john_legend_resize.png__1600x900_crop_subsampling-2.png",
    "https://media.globalcitizen.org/thumbnails/b1/30/b1306303-81c8-4d2c-98d0-fc780528aa72/move_afrika_john_legend_resize.png__1600x900_crop_subsampling-2.png",
    "https://media.globalcitizen.org/thumbnails/b1/30/b1306303-81c8-4d2c-98d0-fc780528aa72/move_afrika_john_legend_resize.png__1600x900_crop_subsampling-2.png"
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto px-4 h-full flex items-end pb-12">
            <div className="text-white">
              ...
              <h1 className="text-4xl font-bold mb-2">
                John Legend - Move Afrika Tour
              </h1>
              <p className="text-xl">February 21, 2025 | BK Arena</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {ticketTypes.map((ticket, index) => (
              <Card key={index} className="p-6 text-center">
                ...
                <Button className="w-full mt-6 bg-amber-600 hover:bg-amber-700">Purchase Now</Button>
              </Card>
            ))}
          </div>
        </div>
      ...
      {/* Sponsors Carousel */}
      <section className="container mx-auto px-40 py-16 ">
