  ...
  const slides = [
    {
      ...
      image:
        "https://fusionestatesafrica.com/wp-content/uploads/2021/10/Kigali-Heights-for-website-1.jpeg",
    ...
    },
    {
      ...
      image:
        "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2b/1c/51/de/hotel-exterior.jpg?w=1100&h=-1&s=1",
      href: "#", // Replace with actual URL
    },
    {
      ...
      image:
        "https://kinyarwanda.com/wp-content/uploads/2021/12/MG_3648-Edit-1-1024x683.jpg",
      href: "#", // Replace with actual URL
    },
  ];
          ...
          >
            <div className="relative h-56 md:h-72">
              ...
              <div className="absolute inset-0 p-6 flex flex-col justify-between">
                <div>
                  <p
                    className={`text-sm font-medium tracking-wide mb-2 ${slide.textColorClass} ${slide.hoverColorClass}`}
                  >
                    {slide.subtext}
                  </p>
                  <h2
                    className={`text-2xl font-extrabold leading-tight ${slide.textColorClass} ${slide.hoverColorClass}`}
                  >
                    {slide.title}
                  </h2>
                </div>
                ...
                <div
                  className={`opacity-0 transition-opacity duration-300 text-3xl ${slide.textColorClass} group-hover:opacity-100`}
                >
                  →
                </div>
              </div>
      ...
      <div className="columbus-content flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0">
        ...
        <div className="columbus-left flex flex-col items-center md:items-start md:w-1/2 space-y-6 ml-4 md:ml-6">
          ...
          <div className="columbus-awards-text text-center md:text-left text-gray-700 text-lg md:text-xl max-w-lg mx-auto md:mx-0">
            <p>
              Kigali has been celebrated as one of Africa’s Cleanest Cities, a
              Top Destination for Innovation and Sustainability, and one of the
              Friendliest and Safest Cities in the World by global travel
              experts and organizations like Condé Nast Traveler and the World
              Travel Awards.
              <br />
              <br />
              With its vibrant culture, breathtaking scenery, and a culinary
              scene that’s gaining international acclaim, Kigali is not just a
              city—it’s an experience. From its lush green hills to its thriving
              arts and tech hubs, Kigali is a city that continues to inspire and
              amaze.
            </p>
          </div>
        </div>
  ...
  const newsCards = [
    {
      ...
      description:
        "A serene eco-park in Kigali offering walking trails, birdwatching, and a peaceful escape into nature.",
      imageUrl:
    ...
    },
    {
      ...
      description:
        "A poignant memorial honoring the victims of the 1994 Genocide against the Tutsi, offering historical insights and reflection.",
      imageUrl:
        "https://lh5.googleusercontent.com/p/AF1QipPxaeXMZnCeFCOxf3MkrGA8IlfgZKAP5TEoMzYq=w540-h312-n-k-no",
      link: "https://www.kgm.rw/",
    },
    {
      title: "Volcanoes National Park",
      description:
        "Home to the endangered mountain gorillas, this park offers unforgettable gorilla trekking experiences in the Virunga Mountains.",
      imageUrl:
    ...
    },
    {
      title: "Lake Kivu",
      description:
        "A stunning freshwater lake perfect for swimming, kayaking, and relaxing by the shores in towns like Gisenyi and Kibuye.",
      imageUrl:
        "https://encrypted-tbn3.gstatic.com/licensed-image?q=tbn:ANd9GcQrcyFCschjDRlznkFCktUOz7RyZNtcBVDBIWE5zlTBBHWj5otFsOkH1ux5nTRTJ4qfXXDOGSNPFF5dcueIW-HDY0kcvu7XVRN0RQZ5qw",
      link: "https://www.visitrwanda.com/destinations/lake-kivu/",
    },
    {
      title: "Akagera National Park",
      description:
        "Rwanda's only savannah park, home to lions, elephants, giraffes, and a variety of wildlife, ideal for safari adventures.",
      imageUrl: "",
    ...
    },
    {
      ...
      description:
        "A vibrant arts center in Kigali showcasing contemporary Rwandan art, workshops, and cultural performances.",
      imageUrl:
        "https://encrypted-tbn3.gstatic.com/licensed-image?q=tbn:ANd9GcQ9O5gqi09FI3awcOu1Gemeued5d6qtSJCHkPfeLVlBnO44DGM1aNd9Xxio5g7aKR7yC_aiJ8__Fp1saKc1CscCZWmRDoa6EAt-aqBtX-c",
      link: "https://www.inemaarts.com/",
    },
    {
      title: "King’s Palace Museum",
      description:
        "Located in Nyanza, this museum offers a glimpse into Rwanda's royal history and traditional architecture.",
      imageUrl: "",
    ...
    },
    {
      ...
      description:
        "A biodiversity hotspot with canopy walks, chimpanzee tracking, and over 1,000 plant species in one of Africa's oldest rainforests.",
      imageUrl:
        "https://encrypted-tbn3.gstatic.com/licensed-image?q=tbn:ANd9GcSllrI7rEVRm04vYwhjsifKZ03o-DWeMS9Mg_juhkC-3GHe0syIob7_MIyL8Qoq9HE5BIMpsDa_VqnlLs5N3sDBx_miBALpXLgughKOW0Q",
      link: "https://www.visitrwanda.com/destinations/nyungwe-national-park/",
    },
    {
      title: "Rwanda Art Museum",
      description:
        "Housed in the former presidential palace, this museum showcases Rwandan art and cultural heritage.",
      imageUrl:
        "https://lh5.googleusercontent.com/p/AF1QipMHK9yQkCYyloMyu1C4VvVEm1v7VX4w1xEubbnH=w675-h390-n-k-no",
      link: "https://www.museum.gov.rw/rwanda-art-museum",
    },
    {
      title: "Mount Karisimbi",
      description:
        "A challenging trek to Rwanda's highest peak, offering breathtaking views and a chance to explore the Virunga Mountains.",
      imageUrl:
        "https://lh5.googleusercontent.com/p/AF1QipNOIGEirHO9T5_31uVlVB1MFF7csPln67eKA3C6=w675-h390-n-k-no",
      link: "https://www.visitrwanda.com/destinations/volcanoes-national-park/",
    },
    {
      title: "Gishwati-Mukura National Park",
      description:
        "A newly established park with lush forests, waterfalls, and opportunities for hiking and primate tracking.",
      imageUrl:
        "https://lh5.googleusercontent.com/p/AF1QipMmpx3g9u0fAkAOsKqBTQj7L1xAhWFOkKLeaz7-=w675-h390-n-k-no",
      link: "https://www.visitrwanda.com/destinations/gishwati-mukura-national-park/",
    },
    {
      title: "Kigali Heights",
      description:
        "A modern shopping and entertainment hub in Kigali, offering restaurants, cafes, and a cinema.",
      imageUrl:
        "https://igihe.com/local/cache-vignettes/L800xH534/dsc_9449-2-94b30-fe6ee.jpg?1728928934",
      link: "https://kigaliheights.com/",
    },
    {
      title: "Rusumo Falls",
      description:
        "A stunning waterfall on the Rwanda-Tanzania border, perfect for nature lovers and photographers.",
      imageUrl:
        "https://encrypted-tbn0.gstatic.com/licensed-image?q=tbn:ANd9GcTFxSEd06JLJmwdrlMJrose81FNywM4D8-W8YGdeZShJpzA9pcblgWYOd8XEMaR-HsDQYerN-uBPyzEj2WqDekidQ2yQjWgMiU5UuZxEME",
      link: "https://www.visitrwanda.com/destinations/rusumo-falls/",
    },
    {
      title: "Iby’Iwacu Cultural Village",
      description:
        "Experience Rwandan culture, traditions, and village life near Volcanoes National Park.",
      imageUrl:
        "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0f/f4/48/24/come-and-enjoy-our-traditional.jpg?w=900&h=500&s=1",
      link: "https://www.ibyiwacu.com/",
    },
    {
      title: "Kigali convestion center",
      description:
        "A bustling market in Kigali where you can shop for fresh produce, crafts, and traditional Rwandan fabrics.",
      imageUrl:
        "https://media-cdn.tripadvisor.com/media/attractions-splice-spp-674x446/12/e8/d6/ef.jpg",
      link: "https://www.visitkigali.rw/kimironko-market/",
    },
    {
      title: "The Musanze Caves",
      description:
        "Explore these fascinating lava tubes formed by volcanic activity, located near Volcanoes National Park.",
      imageUrl:
        "https://lp-cms-production.imgix.net/2020-11/shutterstockRF_34434805.jpg?w=1440&h=810&fit=crop&auto=format&q=75",
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {newsCards
          .slice(0, showMore ? newsCards.length : 4)
          .map((card, index) => (
            <div
              key={index}
        ...
        <div className="md:w-1/2 space-y-6">
          ...
          <div className="space-y-4">
            <p className="text-lg text-gray-600 leading-relaxed">
              Discover the best of Kigali with the KIGALI VIEW Rewards app! Find
              exciting events, top attractions, and exclusive local deals. Earn
              rewards like merchandise, gift cards, and more—all in one
              convenient place.
            </p>
            <p className="text-lg font-medium text-gray-900">
              Download the KIGALI VIEW Rewards app now and start exploring the
              magic of Kigali!
            </p>
          </div>
...
const blogPosts = [
  {
    ...
    description:
      "Experience the vibrant culture of Rwanda through its festivals, from Umuganura to Kwita Izina...",
    image:
      "https://media.licdn.com/dms/image/v2/D4D12AQHddXSv2IOUUQ/article-cover_image-shrink_720_1280/article-cover_image-shrink_720_1280/0/1662536049497?e=1743638400&v=beta&t=ciAOsnCpa4QZ98yFFLNsPLFssMNMmoK4QAP97ftOsBg",
    link: "#",
  },
  {
    title: "Must-Visit National Parks in Rwanda",
    description:
      "Explore Rwanda’s stunning national parks, including Volcanoes, Akagera, and Nyungwe...",
    image:
  ...
  },
  {
    ...
    description:
      "Discover the flavors of Rwanda, from hearty dishes like Ugali and Isombe to local coffee...",
    image:
      "https://paanvuusafaris.com/wp-content/uploads/2024/03/Discovering-the-Culinary-Delights-of-Rwanda-Paanvuu-Safaris.jpeg.webp",
    link: "#",
  },
  {
    title: "Indoor Activities in Kigali for Rainy Days",
    description:
      "Don’t let the rain stop you—visit Kigali’s museums, art galleries, and cozy cafes...",
    image:
      "https://www.carolinesyrup.com/content/images/size/w1000/2022/12/PXL_20220629_132753005.jpg",
    link: "#",
  },
  {
    title: "Gorilla Trekking: A Once-in-a-Lifetime Experience",
    description:
      "Everything you need to know about trekking to see Rwanda’s majestic mountain gorillas...",
    image:
      "https://www.onthegotours.com/cdn-cgi/image/f=auto,q=80,w=506/repository/Male-gorilla-walking-through-forest-660831537271099.jpg",
    link: "#",
  },
  {
    title: "Exploring Kigali’s Art and Music Scene",
    description:
      "Dive into Kigali’s creative side with visits to Inema Arts Center and local music events...",
    image:
      "https://africantravelinc.com/sites/default/files/Kigali%20Art%20x850.png",
    link: "#",
  },
  {
    title: "Sustainable Tourism in Rwanda",
    description:
      "Learn how Rwanda is leading the way in eco-friendly and sustainable tourism...",
    image:
      "https://visitrwanda.com/wp-content/uploads/2020/03/IMG-20200310-WA0003-768x480.jpg",
    link: "#",
  },
  {
    title: "Hidden Gems in Rwanda: Off-the-Beaten-Path",
    description:
      "Discover lesser-known destinations like Lake Kivu, Musanze Caves, and more...",
    image:
      "https://m.mightytravels.com/caches/79aa6a81147c9d542251b5f0837e6def---991.jpg",
    link: "#",
  },
  {
    title: "Rwanda’s Wildlife: A Safari Adventure",
    description:
      "Embark on a wildlife safari in the country’s renowned national parks and reserves...",
    image:
      "https://m.mightytravels.com/caches/79aa6a81147c9d542251b5f0837e6def---991.jpg",
    link: "#",
  },
...
const HotelSearch = () => {
  ...
  const [adults, setAdults] = useState(""); // Track the number of adults
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      setLoading(false);
      alert(
        `Searching for ${adults} adult(s) and ${children} child(ren) from ${checkIn} to ${checkOut}`
      );
    }, 1500);
  };
    ...
    <div className="relative min-h-[400px] bg-gradient-to-br from-indigo-900 via-blue-900 to-purple-900 py-16 px-4">
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <form
          ...
          className="max-w-3xl mx-auto bg-white/10 backdrop-blur-lg rounded-xl p-6 shadow-2xl border border-white/20"
        >
  ...
  const cards = [
    {
      ...
      image:
        "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/08/b0/fa/2a/gisozi-genocide-memorial.jpg?w=1000&h=-1&s=1",
    },
    {
      ...
      image:
        "https://media-cdn.tripadvisor.com/media/attractions-splice-spp-674x446/0b/22/20/01.jpg",
    },
    {
      ...
      image:
        "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/12/41/34/12/ivuka-arts-centre.jpg?w=900&h=500&s=1",
    },
    {
      ...
      image:
        "https://media-cdn.tripadvisor.com/media/attractions-splice-spp-720x480/0f/e3/94/25.jpg",
    },
    {
      ...
      image:
        "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2e/31/88/df/caption.jpg?w=1000&h=-1&s=1",
    },
    {
      title: "Kigali Nature and Wildlife Trail",
      description:
...
const imageCards = [
  {
    id: 1,
    src: "https://media-cdn.tripadvisor.com/media/attractions-splice-spp-674x446/13/43/41/9e.jpg",
    alt: "Image 1",
    text: "Explore Kigali city culture",
  },
  {
    id: 2,
    src: "https://www.ugandarwanda-safaris.com/wp-content/uploads/2024/10/Umutsima.jpg",
    alt: "Image 2",
    text: "Test the food of Kigali",
  },
  {
    id: 3,
    src: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/24/56/69/f1/entrance.jpg?w=900&h=500&s=1",
    alt: "Image 3",
    text: "Discover Hidden Gems in Kigali",
  },
  {
    id: 4,
    src: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/08/b0/fa/7d/gisozi-genocide-memorial.jpg?w=900&h=500&s=1",
    alt: "Image 4",
    text: "Visit Museums to know more about Rwanda",
  },
  {
    id: 5,
    src: "https://www.nkuringosafaris.com/wp-content/uploads/2023/08/kinigi-kwita-izina-__.jpg",
    alt: "Image 5",
    text: "Explore Parks In Rwanda",
  },
  {
    id: 6,
    src: "https://rdb.rw/wp-content/uploads/2023/12/DC_8157_Lv9fDXRT-1024x682.jpeg",
    alt: "Image 6",
    text: "Attend Local Events like Move Africa",
  },
  {
    id: 7,
    src: "https://rwandaclothing.com/wp-content/uploads/2016/01/RWANDA-CLOTHING-STORE-Kigali_-36-570x380.jpg",
    alt: "Image 7",
    text: "Shop Unique Stores",
  },
  {
    id: 8,
    src: "https://cdn.getyourguide.com/img/tour/8dfc8c93e0e94a71.jpeg/98.jpg",
    alt: "Image 8",
    text: "Experience Outdoor Activities",
  },
  {
    id: 9,
    src: "https://en.igihe.com/local/cache-vignettes/L1000xH667/ruger-2-779fa-1843f.jpg?1733238640",
    alt: "Image 9",
    text: "Attend Live Performances with the African stars",
  },
  {
    id: 10,
    src: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/15/56/7f/c8/exterior.jpg?w=900&h=-1&s=1",
    alt: "Image 10",
    text: "Explore Regional Historical Sites",
  },
  {
    id: 11,
    src: "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1c/58/6a/5a/this-is-me-ken-an-artist.jpg?w=900&h=500&s=1",
    alt: "Image 11",
    text: "Attend Art Galleries",
  },
  {
    id: 12,
    src: "https://media-cdn.tripadvisor.com/media/attractions-splice-spp-674x446/12/e3/85/0e.jpg",
    alt: "Image 12",
    text: "Experience Local Culture",
  },
  {
    id: 13,
    src: "https://media-cdn.tripadvisor.com/media/attractions-splice-spp-674x446/0a/3d/5d/3f.jpg",
    alt: "Image 13",
    text: "Attend Music Festivals",
  },
  {
    id: 14,
    src: "https://www.rwandaclothing.com/wp-content/uploads/2016/01/RWANDA-CLOTHING-STORE-Kigali_-36-570x380.jpg",
    alt: "Image 14",
    text: "Shop Unique Stores",
  },
  {
