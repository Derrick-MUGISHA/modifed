...
const TravelSection = () => {
  return (
    <div className="flex flex-wrap w-full">
      ...
      <a
        href="#join"
        className="relative flex-1 p-8 flex flex-col justify-center bg-black transition-all duration-300 hover:opacity-90 min-w-[300px] w-full md:w-auto"
      >
        <div className="max-w-md">
          <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-white">
            Join the RWANDA AIR® Travel Agencies
          </h2>
          <p className="text-base sm:text-lg mb-6 text-cyan-400">
      ...
      <a
        href="#guide"
        className="relative flex-1 p-8 flex flex-col justify-center bg-gradient-to-r from-green-900 to-green-800 transition-all duration-300 hover:opacity-90 min-w-[300px] w-full md:w-auto"
      >
        <div className="max-w-md">
          <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-white">
