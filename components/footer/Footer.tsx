    ...
    <footer className="bg-cover bg-center bg-gray-800 text-white p-10 w-full relative text-center">
      <div className="container mx-auto w-11/12 max-w-6xl flex flex-col z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          <div className="flex flex-col items-start p-4">
            <Image
              ...
              alt="Kigali view"
              className="w-full max-w-[150px] mb-4 opacity-80 grayscale hover:opacity-100 hover:grayscale-0 transition-opacity duration-300"
              width={150} // specify width
              height={150} // specify height
            />

            <p className="text-lg mb-4">
              A Top 10 Best Big City in the Africa
              <br />
              One of the Best Secured Cities in the World
              <br />
          ...
          <div className="flex flex-col items-start p-4">
            ...
            <ul>
              <li>
                ...
                >
                  Trending Places in Kigali / Events
                </a>
              </li>
              <li>
                <a
        ...
        <div className="flex gap-4 justify-center mt-4">
          ...
          <Link
            href="https://x.com/__derr1ck__?t=P-KqVcqqOZeB5lJUN04PLQ&s=03"
            target="_blank"
            rel="noopener noreferrer"
            className="text-white hover:text-gray-400 transition-colors duration-300"
          >
          ...
          <Link
            href="https://www.instagram.com/d.e.r.r.1.c.k?igsh=ZHYwZTg3M3Q2NDJs"
            target="_blank"
            rel="noopener noreferrer"
            className="text-white hover:text-gray-400 transition-colors duration-300"
          >
          ...
          <Link
            href="https://www.linkedin.com/in/mugisha-derrick-479788332/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-white hover:text-gray-400 transition-colors duration-300"
          >
